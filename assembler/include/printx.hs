...
#define DUMP_8S(   Format, mtr, height, width, stride, mode) DUMP_MACRO Format,mtr,height,width,stride,mode,_dump_8s
#define DUMP_16S(  Format, mtr, height, width, stride, mode) DUMP_MACRO Format,mtr,height,width,stride,mode,_dump_16s
#define DUMP_32S(  Format, mtr, height, width, stride, mode) DUMP_MACRO Format,mtr,height,width,stride,mode,_dump_32s
#define DUMP_64S(  Format, mtr, height, width, stride, mode) DUMP_MACRO Format,mtr,height,width,stride,mode,_dump_64s
#define DUMP_8U(   Format, mtr, height, width, stride, mode) DUMP_MACRO Format,mtr,height,width,stride,mode,_dump_8u
#define DUMP_16U(  Format, mtr, height, width, stride, mode) DUMP_MACRO Format,mtr,height,width,stride,mode,_dump_16u
#define DUMP_32U(  Format, mtr, height, width, stride, mode) DUMP_MACRO Format,mtr,height,width,stride,mode,_dump_32u
#define DUMP_64U(  Format, mtr, height, width, stride, mode) DUMP_MACRO Format,mtr,height,width,stride,mode,_dump_64u
#define DUMP_32F(  Format, mtr, height, width, stride, mode) DUMP_MACRO Format,mtr,height,width,stride,mode,_dump_32f
#define DUMP_64F(  Format, mtr, height, width, stride, mode) DUMP_MACRO Format,mtr,height,width,stride,mode,_dump_64u
...
// DUMP_8U( "%0x,", mtr,2,16,16)
// DUMP_16U("%0d ", mtr,2,8,8)
// DUMP_32U("%0x ", mtr,2,4,4)
// DUMP_64U("%0lx ",mtr,2,2,2)
// DUMP_32F("%.3fx ",mtr,2,2,2)
	

.macro DUMP_MACRO format, mtr, height, width, stride, mode, printer
	push ar5,gr5;
	gr5 = \mtr;
